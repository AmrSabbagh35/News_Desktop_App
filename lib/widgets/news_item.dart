...
import 'package:news_desktop_app/models/article.dart';
import 'package:news_desktop_app/widgets/flyout_widget.dart';
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: Text(
                          article.title,
                          style:
                              typography.bodyLarge?.apply(fontSizeFactor: 0.8),
                          maxLines: 3,
                        ...
                        children: [
                          Expanded(
                            child: Text(
                              article.captionText(),
                              style:
                                  typography.caption?.apply(fontSizeFactor: 1),
                              maxLines: 1,
                              overflow: TextOverflow.ellipsis,
                            ),
                          ),
